...
import { BRANCH_STORAGE_KEY, normalizeBranch } from "./utils/branch";
...
export default function App() {
  ...
  useEffect(() => {
    localStorage.setItem(BRANCH_STORAGE_KEY, branchSection);
  }, [branchSection]);
  ...
  return (
    <>
      ...
      {showDashboard ? (
        <BranchProvider branchSection={branchSection} onBranchChange={setBranchSection}>
