  ...
  return (
    <div className="space-y-4">
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              {filtered.map((student) => (
                <tr key={student._id} className={dark ? "border-b border-white/[0.06]" : "border-b border-slate-100"}>
                  <td className={`px-4 py-3 font-mono text-xs ${dark ? "text-[#9e9e9e]" : "text-slate-600"}`}>
                    {student.rollNumber || "—"}
                  </td>
                  <td className={`px-4 py-3 font-medium ${dark ? "text-white" : "text-slate-800"}`}>{studentFullName(student)}</td>
                    ...
                    >
                      <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path
                          ...
                          d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 11h-6"
                        />
                      </svg>
      ...
      <ConfirmDialog
        ...
        message={pendingStudent ? "Are you sure you want to remove this student from school?" : ""}
