...
export default function FeeNotificationPopup({ open, onClose, dark = false }) {
  ...
  const popup = (
    <div
      className={`${backdropClass} fixed inset-0 z-[9999] flex items-start justify-center px-4 pt-20 ${
    ...
    >
      ...
      >
        ...
        <div className={`${bodyClass} max-h-[70vh] overflow-y-scroll p-4`} style={{ scrollbarGutter: "stable" }}>
          {loading ? (
            ...
            <div className={`overflow-hidden rounded-2xl border ${dark ? "border-white/[0.06]" : "border-slate-200"}`}>
              ...
              <div className="min-w-[1100px] divide-y" style={{ divideColor: dark ? "rgba(255,255,255,0.06)" : "rgb(226 232 240)" }}>
                {groupedItems.map((item) => {
                  ...
                  return (
                    <div key={item.key} className={`${dark ? "bg-[#161722] text-white" : "bg-white text-slate-700"}`}>
                      <div className="grid grid-cols-[1.2fr_1.2fr_1fr_0.75fr_1fr_0.8fr_0.8fr] gap-0 px-4 py-4 text-sm">
                        ...
                        <span className="text-[16px] font-semibold leading-none text-rose-600">
                          Rs. {Number(item.pendingAmount || 0).toLocaleString()}
                        </span>
                      </div>
                            ...
                            <div className="space-y-2">
                              {item.feeDetails.map((fee, index) => (
                                ...
                                >
                                  ...
                                  <p className="shrink-0 self-center text-[16px] font-semibold leading-none text-rose-600">
