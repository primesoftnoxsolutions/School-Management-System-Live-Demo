...
export default function FormModal({
  ...
  const widthClass = maxWidthClass || (extraWide ? "max-w-6xl xl:max-w-7xl" : wide ? "max-w-3xl" : "max-w-2xl");
  ...
  return createPortal(
    ...
    <div
      ...
      className={`${backdropClass} fixed inset-0 z-[500] flex items-center justify-center px-4 ${
    ...
    >
      ...
      <div
        ...
        className={`${panelClass} relative z-[501] flex max-h-[90vh] w-full flex-col overflow-hidden ${widthClass} ${
